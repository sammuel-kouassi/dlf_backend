...
--
-- Class Distribution as table distribution
--
...
--
-- Class Participant as table participant
--
...
--
-- Class PriseContact as table prise_contact
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('dlf_backend', '20260408172429164', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260408172429164', "timestamp" = now();
